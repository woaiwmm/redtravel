...
;(function(window) {
	...
	function init() {
		...
		imagesLoaded(body, function() {
			...
			// Init/Bind events.
			initEvents();
			// Remove picloading class from body
			body.classList.remove('picloading');
		});
	}
	...
	function applyFx(ev) {
		// Simulate picloading grid to show the effect.
		clearTimeout(loadingTimeout);
		grids[currentGrid].classList.add('grid--picloading');

		loadingTimeout = setTimeout(function() {
			grids[currentGrid].classList.remove('grid--picloading');
